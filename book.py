...
df = pd.read_csv('./book/train_dataset.csv')
...
# 模型保存
torch.save(model.state_dict(),"./book_model/model.h5")
...
df = pd.read_csv('E:/学校/学习资料/Python/pythonDL/book/test_dataset.csv')
...
f = open('E:/学校/学习资料/Python/pythonDL/book/submission.csv', 'w', encoding='utf-8')
